...
let
  prismlauncherftb' = prismlauncherftb-unwrapped.override {
    inherit msaClientID gamemodeSupport;
  };
in

symlinkJoin {
  name = "prismlauncherftb-${prismlauncherftb'.version}";

  paths = [ prismlauncherftb' ];
